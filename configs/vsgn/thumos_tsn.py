...
model = dict(
    ...
    roi_head=dict(roi_extractor=dict(tscale=window_size, base_stride=1)),
)


solver = dict(
    train=dict(batch_size=16, num_workers=4), # 32
...
scheduler = dict(type="MultiStepLR", milestones=[20], max_epoch=50)
